...
Only unordered (bulleted) lists are supported at this time.  (This
should be fixed in the future.)  Each of the following syntaxes are
supported:
...
write it like this, using hyphens:
